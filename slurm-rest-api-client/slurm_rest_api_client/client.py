...
class Client(_BaseModel):
    ...
    def with_headers(self, headers: dict[str, str]) -> "Client":
        ...
        return self.model_copy(update={"headers": {**self._headers, **headers}})
    ...
    def with_cookies(self, cookies: dict[str, str]) -> "Client":
        ...
        return self.model_copy(update={"cookies": {**self._cookies, **cookies}})
...
class AuthenticatedClient(_BaseModel):
